#include <hhcm_bt_cpp_libs/CheckClosestFramePub.h>

using hhcm_bt::CheckClosestFramePub;

CheckClosestFramePub::CheckClosestFramePub(
    const std::string& name, const BT::NodeConfig& config, 
    ros::NodeHandle* nh, const std::string& pub_topic_name, hhcm_bt::TF::Ptr tf) :
    BT::RosPubNode<std_msgs::String>(name, config, nh, pub_topic_name),
    _tf(tf)
{
...
BT::PortsList CheckClosestFramePub::providedPorts() {
...
bool CheckClosestFramePub::modifyMsg() {
