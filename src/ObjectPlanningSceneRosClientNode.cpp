#include <hhcm_bt_cpp_libs/ObjectPlanningSceneRosClientNode.h>

using hhcm_bt::ObjectPlanningSceneRosClientNode;

ObjectPlanningSceneRosClientNode::ObjectPlanningSceneRosClientNode(
    const std::string& name, const BT::NodeConfig & conf,
        ...
        BT::RosServiceNode<moveit_msgs::ApplyPlanningScene>(name, conf, nh, service_name),
...
BT::PortsList ObjectPlanningSceneRosClientNode::providedPorts() {
...
bool ObjectPlanningSceneRosClientNode::prepareRequest(RequestType& request) {

    return true;
}

bool ObjectPlanningSceneRosClientNode::modifyRequest(RequestType& request) {
...
bool ObjectPlanningSceneRosClientNode::create_object(const std::string& id, 
...
bool ObjectPlanningSceneRosClientNode::get_ports() {
...
BT::NodeStatus ObjectPlanningSceneRosClientNode::onResponse( const ResponseType& res) {
